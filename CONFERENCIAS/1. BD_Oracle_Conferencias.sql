...
insert into Conferencia values ('POO1314','Programación Orientada a Objetos',20.00,'02/10/2013','M','Zeus');
insert into Conferencia values ('PWB1314','Programación Web',18.50,'02/10/2013','T','Apolo');
insert into Conferencia values ('ADS1314','Accediendo a datos de forma segura',12.50,'03/10/2013','M','Afrodita');
insert into Conferencia values ('SEG1314','Seguridad Informática en la Empresa',15.00,'03/10/2013','T','Apolo');
...
insert into Ponente values ('ESP003', 'Julián', 'Amorós', 'Pérez','Seguridad Informática');
...
insert into Asistente values ('AS0001', 'Mario', 'Céspedes', 'Hermida','H','16/11/1970','BK Programación');
insert into Asistente values ('AS0002', 'Carmen', 'Gutiérrez', 'Sevilla','M','20/02/1968','BK Programación');
insert into Asistente values ('AS0003', 'Felipe', 'Martín', 'Comillas','H','06/11/1975','ProgConsulting');
insert into Asistente values ('AS0004', 'Lourdes', 'Soriano', 'López','M','30/07/1982',null);
insert into Asistente values ('AS0005', 'Inmaculada', 'Herrero', 'Puig','M','13/09/1978','BigSoft');
insert into Asistente values ('AS0006', 'Lucía', 'Díaz', 'Martínez','M','25/08/1973','BigSoft');
insert into Asistente values ('AS0007', 'Fermín', 'Gutiérrez', 'Páez','H','03/03/1969','ProgConsulting');
insert into Asistente values ('AS0008', 'José Enrique', 'Martos', 'Martos','H','20/10/1982','BK Programación');
insert into Asistente values ('AS0009', 'José Ramón', 'Gómez', 'Pérz','H','21/01/1973','ProgConsulting');
insert into Asistente values ('AS0010', 'Mercedes', 'Bosh', 'Toral','M','05/05/1980','BK Programación');
insert into Asistente values ('AS0011', 'María José', 'Vázquez', 'Soriano','M','19/03/1990',null);
insert into Asistente values ('AS0012', 'José Luis', 'Jiménez', 'Molina','H','01/10/1991','BigSoft');
insert into Asistente values ('AS0013', 'Manuel', 'Pérez', 'Martínez','H','30/11/1987',null);
